...
interface SongAudioMediaDao {
    ...
    @Query("UPDATE song_audio_media SET local_audio_path = :localAudioPath WHERE id = :mediaId")
    suspend fun updateAudioMediaLocalPath(mediaId: Int, localAudioPath: String) // for songs downloading
